...
== VICONIJ IF ~InParty("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN ~I remember you, elg'caress. You were such an amusing statue with your mouth forever drooling. Pity someone had set you free.~
...
CHAIN O#BRAN b1.1
~I am glad to be part of your war party. I will not make you regret your decision!~
END
+ ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + ~I should probably tell you that I am going to rescue Imoen from the Cowled Wizards.~ EXTERN O#BRAN b1.3
+ ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + ~I am going to find Irenicus, the mage who kidnapped and tortured me.~ EXTERN O#BRAN b1.4
++ ~All right, let's go.~ EXTERN O#BRAN b1.join
...
CHAIN O#BRAN b1.3
~You have saved me, and for that I owe you my life. I am indebted to you, and, by Tempus, I leave no debt unpaid! Let us save Imoen together.~
END
IF ~~ EXTERN O#BRAN b1.join 

CHAIN O#BRAN b1.4
~Then I shall join you and bring the favor of the Lord of Battles upon us. Let the wizard tremble in his lair!~
END
IF ~~ EXTERN O#BRAN b1.join 

CHAIN O#BRAN b1.join
~Come, tell me of your new adventures as we walk.~
...
SAY ~Perhaps you have changed your mind, and now need my skills?~
++ ~I have indeed. Welcome aboard.~ + b1.1
++ ~Not at the moment.~ + b1.2
END 
